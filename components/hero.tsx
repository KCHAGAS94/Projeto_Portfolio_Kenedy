...
export function Hero() {
  return (
    <div className="min-h-screen flex flex-col relative">
      {/* Theme Toggle Button - Bottom left position */}
      <div className="fixed bottom-6 left-6 z-50">
        <ThemeToggle />
      </div>

      {/* Header Image - Full width breakout */}
      <div className="-mx-6 lg:mx-0 mb-8 lg:mb-12 lg:-mt-2">
        {/* Mobile Image */}
        <div className="relative w-full h-32 xs:h-40 sm:h-48 md:h-56 lg:hidden">
          <Image
            src="/capakenedy.jpg"
            alt="Kenedy Chagas - Desenvolvedor Full Stack"
            fill
        ...
        {/* Desktop Image */}
        <div className="relative w-full h-80 xl:h-96 hidden lg:block">
          <Image
            src="/capakenedydesktop.jpg"
            alt="Kenedy Chagas - Desenvolvedor Full Stack"
            fill
      ...
      <section className="flex-1 flex flex-col justify-center px-6 lg:px-0">
